...
import { ImageIcon, PaperPlaneRightIcon, SpinnerIcon } from '@phosphor-icons/react/dist/ssr';
...
export function ChatInput({
  ...
  const handleImageUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      // Send file via data channel on "images" topic
      await localParticipant.publishData(uint8Array, {
        topic: 'images',
        reliable: true,
      });
    ...
    <div className="border-input/50 flex w-full items-start overflow-hidden border-b">
      ...
      >
        ...
        <input
          ...
          className="h-8 flex-1 focus:outline-none disabled:cursor-not-allowed disabled:opacity-50 [&::-ms-clear]:hidden [&::-webkit-clear-button]:hidden [&::-webkit-search-cancel-button]:hidden"
          style={{
